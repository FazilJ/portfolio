        ...
        <div className="flex flex-col md:flex-col gap-10">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
            ...
            <p className="text-lg text-gray-700 mb-4">
              This is a E-commerce shoping Website.Built using
                React, Javascript, Node.js, and styled with Bootstrap CSS.
            </p>
            <a
              href="https://fasioncard.netlify.app/"
          ...
          <div className="w-full md:w-1/2 flex flex-col place-self-end bg-[#F2EFE5] p-6 rounded-2xl shadow-lg">
          <h1 className="text-center text-[#fe5617] font-extrabold text-[32px] mb-4">Admin-Dashboard</h1>
          <p className="text-lg text-gray-700 mb-4">
          Developed a responsive admin dashboard for managing e-commerce operations using React.js and Bootstrap.
            </p>
            <a
              href="https://admin-dashboardcard.netlify.app/"
              className="text-[#fe5617] text-center font-bold text-lg hover:underline"
            >
              Live Demo
            </a>
